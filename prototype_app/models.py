...
class Contractor(models.Model):
    ...
    credit_limit = models.DecimalField(max_digits=147455, decimal_places=16383, blank=True, null=True)
...
class ContractorFullData(models.Model):
    id = models.BigIntegerField(primary_key=True)
    object_id = models.BigIntegerField(unique=True)
    part_of_object_id = models.BigIntegerField(blank=True, null=True)
    state_id = models.BigIntegerField(blank=True, null=True)
    ...
    fl_egryul = models.TextField(blank=True, null=True)
